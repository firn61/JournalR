...
@Repository
public class ReportsDAO implements IReporstDAO{
    ...
    public List<String[]> getReportAllPodstations(int currentDate){
        ...
        List<String[]> result = jdbcTemplate.query(queryTemplate, new Object[]{currentDate}, (ResultSetExtractor<List>) rs -> {
    ...
    public List<String[]> getOverloadedPodstations(int currentDate) {
        ...
        List<String[]> overloadedPodstations = jdbcTemplate.query(queryTemplate, new Object[]{currentDate}, (ResultSetExtractor<List>) rs -> {
            List<String[]> extractedList = new ArrayList<String[]>();
            while (rs.next()) {
